...
export default function Footer({ data, region, lang, translations }) {
  ...
  return (
    <footer
      id={id}
      className={`relative z-10 bg-primary py-10 md:pb-8 md:pt-16 ${buildYourOwn ? 'hidden' : ''}`}>
      <div className="container relative mx-auto px-4 3xl:max-w-[1314px] 3xl:px-0">
        <div className="flex flex-col gap-y-10 md:gap-y-[60px]">
          <div className="flex flex-col gap-y-10 lg:flex-row lg:gap-x-[50px] lg:gap-y-[0px] xl:gap-x-[100px] 2xl:gap-x-[154px]">
            <div className="flex flex-col gap-y-10 lg:max-w-[300px] xl:max-w-[352px]">
              ...
              {_.isEmpty(footerText) || (
                <div
                  className="font-noto text-[12px] font-normal leading-[24px] text-white xl:pt-[20px] xl:text-[15px]"
                ...
                {_.map(groupWebsiteUrl, (item, ind) => {
                  ...
                  return (
                    <Link
                      ...
                      href={itemUrl}
                      target={item.target}
                      className="relative flex w-fit flex-row items-center gap-x-2 pt-[2px] font-noto text-[12px] font-bold leading-[30px] text-white hover:text-tymRed svg-child-path:!stroke-white svg-child-path:stroke-[1.5px] hover:svg-child-path:!stroke-tymRed md:gap-x-[12px] xl:text-[15px]">
