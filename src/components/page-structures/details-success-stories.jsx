...
function DetailsSuccessStories(props) {
  ...
  const isSuccessStories = _.get(props, 'isSuccessStories', false);
  ...
  const heroImages = _.get(data, 'properties.heroImages[0]', null);
  ...
  const backButton = {
    icon: 'ArrowRight',
    label: region === '한국' ? '목록으로 돌아가기' : 'Back to all stories from the field',
  };
...
export default DetailsSuccessStories;
