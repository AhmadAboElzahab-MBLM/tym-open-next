      ...
      <div className="relative flex w-full flex-col gap-y-3 bg-white pt-12">
        ...
        <div
          className="relative flex flex-col gap-y-6 bg-porcelain
            ...
            before:block before:w-full before:-translate-x-1/2 before:-translate-y-full
            before:bg-porcelain
            before:py-9 before:content-[''] md:px-10 md:pb-10">
          <div className="flex flex-col gap-y-2">
            <h4 className="z-10 font-sans text-clamp18to21 font-bold leading-1.125">
              <span className="uppercase">{selected.properties.title}</span>
              {` (${getProductPower(selected, isKO)})`}
            </h4>
