...
function ItemModal({ isOpen, selected, handleClick, width }) {
  ...
  return (
    <div
      ...
      className="absolute left-1/2 z-20 -translate-x-1/2 translate-y-4 shadow-2xl">
      <div className="relative flex w-full flex-col gap-y-3 bg-white pt-12">
        ...
        {_.isEmpty(selected.properties.highlightSpecificationThumbnail) || (
          <div className="flex flex-row justify-center gap-x-1 pl-8 lg:w-[calc(100%-40px)]">
            {_.map(
        ...
        <div
          className="relative flex flex-col gap-y-6 bg-porcelain
            px-5 pb-5 before:absolute before:left-1/2 before:top-0 before:z-0
            before:block before:w-full before:-translate-x-1/2 before:-translate-y-full before:bg-porcelain
            before:py-9 before:content-[''] md:px-10 md:pb-10">
