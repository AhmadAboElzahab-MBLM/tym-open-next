...
export default function FeaturesGallery({ data }) {
  const uspItems = _.get(data, 'properties.uspItems', null);
  ...
  return (
    <>
      <section id="featured_gallery" className="bg-white pt-10 md:pt-[100px]">
        <BoxedContainer>
                  ...
                  return (
                    ...
                    md:border-b-grey md:border-l-grey md:border-r-grey md:border-t-grey">
                      <div
                        ...
                        pr-[20px] md:w-[560px] lg:gap-y-[20px] lg:py-[40px] lg:pl-[40px] lg:pr-[70px]">
                        {_.isEmpty(itemTitle) || (
                          <div
                            className="text-center font-noto text-clamp16to18
                            font-bold leading-1.625 text-primary md:text-left"
                            dangerouslySetInnerHTML={{ __html: itemTitle }}
                          />
                        )}
                        {_.isEmpty(itemText) || (
                          <div
                            className="flex flex-col gap-y-2.5 text-center font-noto
                            text-clamp12to15 font-normal leading-1.625 text-primary md:text-left
                            lg:gap-y-5"
                        ...
                        {_.isEmpty(itemImage) || (
                          <>
                            <button
                              ...
                              className="absolute right-5 top-5 z-[5] cursor-pointer bg-[#333]
                              p-[4px] feature-gallery-fullscreen">
